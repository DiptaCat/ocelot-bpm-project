...
<div>
    <div id="list-bpm" class="content" role="main">
                ...
                <div class="controls" style="font-style: italic">
                    <ul class="one-to-many">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <g:each in="${userInstance?.bpms?.sort { a, b -> a.name.compareTo(b.name) } ?}" status="i"
                                    var="bpm">
                ...
                <div class="controls" style="font-style: italic">
                    <ul class="one-to-many">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <g:each in="${userInstance?.bpms?.sort { a, b -> a.lastUpdated.compareTo(b.lastUpdated) }?.reverse()}"
                                    status="i" var="bpm">
                                <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                    <td><g:link controller="bpm" action="show"
                                                id="${bpm.id}">${bpm?.name}</g:link>
