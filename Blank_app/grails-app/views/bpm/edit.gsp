<%@ page import="org.springframework.validation.FieldError; blank.Bpm" %>
<!DOCTYPE html>
<html>
<head>
    <meta name="layout" content="main">
    <g:set var="entityName" value="${message(code: 'bpm.label', default: 'Bpm')}"/>
    <title><g:message code="default.edit.label" args="[entityName]"/>  ${bpmInstance.toString()}</title>
</head>
...
<div id="edit-bpm" class="content scaffold-edit" role="main">
    ...
    <g:hasErrors bean="${bpmInstance}">
        <ul class="errors" role="alert">
            <g:eachError bean="${bpmInstance}" var="error">
    ...
    <g:form class="form-horizontal" method="post">
        ...
        <g:hiddenField name="version" value="${bpmInstance?.version}"/>
        <fieldset class="form">
