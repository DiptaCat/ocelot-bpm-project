<%@ page import="org.springframework.validation.FieldError; ocelot.Member" %>
<!DOCTYPE html>
<html>
<head>
	<meta name="layout" content="main">
	<g:set var="entityName" value="${message(code: 'user.label', default: 'Member')}"/>
	<title><g:message code="default.edit.label" args="[entityName]"/>  ${memberInstance.toString()}</title>
</head>
