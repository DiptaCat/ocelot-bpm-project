...
//Service for Form Data elements
ocelotServices.factory("FormData", function ($resource) {
	return $resource("/ocelot-mt/api/formData/:formId", null, {'update': {method: 'PUT'}, 'query': {method: 'GET', isArray: true}});
});
